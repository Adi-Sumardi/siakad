 ...
 *
 * Email only. The free-text Sendago WhatsApp leg was dropped on the school's
 * decision (2026-09-18); an SPP receipt now also goes out over WhatsApp
 * through Qontak's approved 'receipt_spp_school' template instead (see
 * PaymentReceiptSender, requested 2026-09-23). The in-app half is the wali
 * navbar bell's "Pembayaran diterima" section, which reads the live payments
 * feed rather than anything stored here, so a settled payment still shows up
 * there within a refresh cycle even for a contact with no email address.
 */
