...
return [
    ...
    */
    ...
    // Multi-bank Virtual Account configurations
    'banks' => [
        'muamalat' => [
            'key' => 'muamalat',
            'name' => 'Bank Muamalat',
            'code' => '147',
            'institution_code' => '8020',
            'prefixes' => [
                'spp' => env('BILLING_API_PREFIX_SPP', '802001'),
                'uang_pangkal' => env('BILLING_API_PREFIX_UANG_PANGKAL', '802002'),
                'jamiyyah' => env('BILLING_API_PREFIX_JAMIYYAH', '802003'),
        ...
        'bsi' => [
            ...
            'code' => '451',
            'institution_code' => '3656',
            'prefixes' => [
                'spp' => env('BILLING_API_PREFIX_BSI_SPP', '365601'),
                'uang_pangkal' => env('BILLING_API_PREFIX_BSI_UANG_PANGKAL', '365602'),
                'jamiyyah' => env('BILLING_API_PREFIX_BSI_JAMIYYAH', '365603'),
                'pendaftaran' => env('BILLING_API_PREFIX_BSI_PENDAFTARAN', '365604'),
                'ekskul_tk' => env('BILLING_API_PREFIX_BSI_EKSKUL_TK', '365605'),
                'ekskul_sd' => env('BILLING_API_PREFIX_BSI_EKSKUL_SD', '365606'),
                'ekskul_smp12' => env('BILLING_API_PREFIX_BSI_EKSKUL_SMP12', '365607'),
                'ekskul_smp55' => env('BILLING_API_PREFIX_BSI_EKSKUL_SMP55', '365608'),
            ],
        ],
    ],
